package com.temporary.overlayutil;
    ...
    private BitmapDescriptor getIconForStep(TransitRouteLine.TransitStep step) {
        switch (step.getStepType()) {
            case BUSLINE:
                ...
                return BitmapDescriptorFactory.fromResource(R.mipmap.icon_bus_station);
            case SUBWAY:
                //return BitmapDescriptorFactory.fromAssetWithDpi("Icon_subway_station.png");
                return BitmapDescriptorFactory.fromResource(R.mipmap.icon_subway_station);
            case WAKLING:
                //return BitmapDescriptorFactory.fromAssetWithDpi("Icon_walk_route.png");
                return BitmapDescriptorFactory.fromResource(R.mipmap.icon_walk_route);
            default:
                return null;
        }
    }
